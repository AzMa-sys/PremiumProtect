    ...
    if request.method == 'POST':
        try:
            ...
            return JsonResponse({
                ...
                'tinting_prices': float(tinting_prices),
                'armor_prices': float(armor_prices)
            })
    ...
    if request.method == 'POST':
        try:
            ...
            for element_id in selected_tinting_elements:
                ...
                if price_config:
                    price_value = float(price_config.price)
                    tinting_prices.append({
                        'name': price_config.element.name,
                        'price': price_value
                    })
                    tinting_total += price_value
            ...
            return JsonResponse({
                ...
                'tinting_prices': tinting_prices,  #  это список, а не число
                'armor_prices': armor_prices       #  это список, а не число
            })
